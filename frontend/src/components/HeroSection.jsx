...
const HeroSection = ({ rentedDate, returnedDate, vehicleGroups, selectedGroup, onChangeVehicleGroup, onChangeRentedDate, onChangeReturnedDate }) => {
    const navigate = useNavigate();

    const handleChange = (event) => {
      onChangeVehicleGroup(event.target.value);
    };
          ...
          <div className='w-full max-w-md p-6 bg-white shadow-md rounded-xl'>
            ...
            <form className='space-y-2'>
              ...
              <button
                type='button'
                onClick={() =>
                  navigate('/vehicles', { state: { selectedGroup, rentedDate, returnedDate } })
                }
