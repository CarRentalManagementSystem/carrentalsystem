            ...
            <div className="relative z-10 flex flex-col items-center justify-between gap-10 lg:flex-row">
                ...
                <div className="w-full space-y-6 text-center lg:w-1/2 lg:text-left">
                    ...
                    <p className="text-sm sm:text-base font-['Work_Sans'] max-w-md mx-auto lg:mx-0">
                        Discover a seamless way to rent your perfect car.
                        Reliable, fast, and ready when you are.
                    </p>
                    <button className="bg-orange-400 text-white text-lg font-['Work_Sans'] font-medium p-2 rounded hover:bg-orange-500 transition">
                        View all cars
                    </button>
                </div>
